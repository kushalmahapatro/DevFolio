...
class GetInTouchMob extends StatefulWidget {
  @override
  _GetInTouchMobState createState() => _GetInTouchMobState();
}

class _GetInTouchMobState extends State<GetInTouchMob> {
                            ...
                            child: Padding(
                              ...
                              child: DropdownButtonHideUnderline(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    if (value != null) _projectType = value;
                                  });
                                },
                                items: projectType
                                    .map(
                          ...
                          Material(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButtonHideUnderline(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    if (value != null) _estBudget = value;
                                  });
                                },
                                items: estBudget
                                    .map(
                        ...
                        children: [
                          ...
                          Material(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButtonHideUnderline(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    if (value != null) _projectDuration = value;
                                  });
                                },
                          ...
                          SizedBox(
                            ...
                            child: OutlinedCustomBtn(
                              btnText: "Send",
                              onPressed: () {
                                final String subject = "New Project Request";
